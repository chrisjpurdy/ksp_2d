...
// number of objects that rapidjsonsdasf::Value allocates memory for by default
...
// number of array elements that rapidjsonsdasf::Value allocates memory for by default
